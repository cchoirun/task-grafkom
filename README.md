...
Cloning the repo with all its history results in a ~2 GB donwload. If you don't need the whole history, you can use the depth parameter to significantly reduce download size.
```
